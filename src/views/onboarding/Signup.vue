        ...
        <form @submit.prevent="handleSignup" class="space-y-5">
          ...
          <div class="grid grid-cols-2 gap-3">
            <div v-if="!googleClientId">
              <button type="button" @click.prevent="handleGoogleSignIn" class="flex items-center justify-center px-4 py-3 border border-gray-200 rounded-button hover:bg-gray-50 transition-colors">
