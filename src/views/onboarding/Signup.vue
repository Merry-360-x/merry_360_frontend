  ...
  <div class="min-h-screen bg-white flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8">
        ...
        <h2 class="mt-6 text-4xl font-bold text-gray-900">Create Account</h2>
        <p class="mt-2 text-gray-600">Join us to start your journey</p>
      </div>
      ...
      <div class="mt-6 text-center">
        <p class="text-gray-600">
          ...
          <router-link to="/login" class="text-brand-600 font-semibold hover:text-brand-700 ml-1">
            Sign In
          </router-link>
        </p>
      </div>
