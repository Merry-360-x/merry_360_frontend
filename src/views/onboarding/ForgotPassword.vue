  ...
  <div class="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-12">
    <div class="max-w-md w-full">
      ...
      <div class="text-center mb-8 animate-fade-in">
        ...
        <h2 class="mt-6 text-3xl font-bold text-text-brand-600">{{ t('auth.forgotPasswordTitle') }}</h2>
        <p class="mt-2 text-text-secondary">{{ t('auth.forgotPasswordSubtitle') }}</p>
      </div>
      ...
      <Card padding="lg" class="animate-slide-in">
        ...
        <div v-else class="text-center space-y-4">
          ...
          <h3 class="text-xl font-semibold text-text-brand-600">{{ t('auth.checkEmail') }}</h3>
