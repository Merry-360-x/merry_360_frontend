          ...
          <div class="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
            <div class="relative h-48 overflow-hidden">
              ...
              <div class="absolute bottom-4 left-4">
                <div class="w-12 h-12 bg-white/90 dark:bg-gray-900/80 rounded-full flex items-center justify-center">
      ...
      <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div class="text-center">
            <div class="w-16 h-16 bg-brand-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div class="text-center">
            <div class="w-16 h-16 bg-green-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div class="text-center">
            <div class="w-16 h-16 bg-blue-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <div class="text-center">
            <div class="w-16 h-16 bg-purple-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-4">
