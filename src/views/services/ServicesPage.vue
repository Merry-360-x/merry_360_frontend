        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div class="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <div class="p-6">
              ...
              <button @click="openAIConcierge" class="block w-full text-center px-6 py-3 bg-brand-500 text-white rounded-xl font-semibold hover:bg-brand-600 transition-colors">
          ...
          <div class="group bg-white dark:bg-gray-800 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <div class="p-6">
              ...
              <router-link to="/become-host" class="block w-full text-center px-6 py-3 bg-brand-500 text-white rounded-xl font-semibold hover:bg-brand-600 transition-colors">
                {{ t('nav.becomeHost') }}
              </router-link>
            </div>
          </div>
