...
const inputClasses = computed(() => {
  const baseClasses = 'w-full px-4 py-3 rounded-button border transition-all duration-200 ease-out focus:outline-none focus:ring-2 text-base text-text-primary dark:text-white placeholder:text-text-muted/60 dark:placeholder:text-gray-400'
  ...
  const disabledClass = props.disabled ? 'bg-gray-50 dark:bg-gray-700 cursor-not-allowed opacity-60' : 'bg-white dark:bg-gray-800'
