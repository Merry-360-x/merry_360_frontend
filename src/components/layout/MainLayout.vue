<template>
  <div class="min-h-screen flex flex-col bg-white dark:bg-gray-800 font-sans transition-colors duration-200">
    ...
    <header class="bg-white dark:bg-gray-900 shadow-md sticky top-0 z-50 border-b border-gray-200 dark:border-gray-700 transition-colors duration-200">
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
          ...
          <!-- Mobile Right - Simplified like Airbnb -->
    ...
    <nav class="lg:hidden fixed bottom-0 left-0 right-0 bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 z-40 safe-area-inset">
      <div class="flex items-center justify-around px-2 py-2">
        <!-- Explore -->
        <router-link 
          to="/"
          class="flex flex-col items-center justify-center px-4 py-2 rounded-lg transition-colors"
          active-class="text-brand-500 dark:text-brand-400"
          exact
        >
          <svg class="w-6 h-6 mb-1" :class="$route.path === '/' ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 dark:text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
          </svg>
          <span class="text-xs font-medium" :class="$route.path === '/' ? 'text-brand-500 dark:text-brand-400' : 'text-gray-600 dark:text-gray-400'">Explore</span>
        </router-link>

        <!-- Wishlist -->
        <router-link 
          to="/dashboard/watchlist"
          class="flex flex-col items-center justify-center px-4 py-2 rounded-lg transition-colors relative"
          active-class="text-brand-500 dark:text-brand-400"
        >
          <svg class="w-6 h-6 mb-1" :class="$route.path.includes('/watchlist') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 dark:text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>
          </svg>
          <span class="text-xs font-medium" :class="$route.path.includes('/watchlist') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-600 dark:text-gray-400'">Wishlist</span>
        </router-link>
        ...
        <router-link 
          ...
          active-class="text-brand-500 dark:text-brand-400"
        >
          <svg class="w-6 h-6 mb-1" :class="$route.path.includes('/dashboard') && !$route.path.includes('/watchlist') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 dark:text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
          </svg>
          <span class="text-xs font-medium" :class="$route.path.includes('/dashboard') && !$route.path.includes('/watchlist') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-600 dark:text-gray-400'">Trips</span>
        </router-link>
        ...
        <router-link 
          ...
          active-class="text-brand-500 dark:text-brand-400"
        >
          <svg class="w-6 h-6 mb-1" :class="$route.path.includes('/profile') || $route.path.includes('/login') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-500 dark:text-gray-400'" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"></path>
          </svg>
          <span class="text-xs font-medium" :class="$route.path.includes('/profile') || $route.path.includes('/login') ? 'text-brand-500 dark:text-brand-400' : 'text-gray-600 dark:text-gray-400'">{{ userStore.isAuthenticated ? 'Profile' : 'Log in' }}</span>
        </router-link>
      </div>
    </nav>
