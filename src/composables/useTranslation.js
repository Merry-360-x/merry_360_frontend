...
const translations = {
  EN: {
    ...
    'auth.resendEmail': "Didn't receive the email? Click to resend",
  ...
  RW: {
    ...
    'auth.resendEmail': "Ntiwayakire imeri? Kanda uyongeremo",
    'auth.brandName': 'Merry360X',
    
    // Checkout & Payment
    'checkout.title': 'Soza Gutangaza Kwawe',
    'checkout.guestInfo': 'Amakuru y\'Umushyitsi',
    'checkout.firstName': 'Izina Rya Mbere',
    'checkout.lastName': 'Izina Rya Nyuma',
    'checkout.email': 'Imeri',
    'checkout.phone': 'Nimero ya Telefoni (urugero, +250 7XX XXX XXX)',
    'checkout.paymentMethod': 'Uburyo bwo Kwishyura',
    'checkout.creditCard': 'Ikarita y\'Inguzanyo / Amadeni',
    'checkout.mobileMoney': 'Amafaranga y\'Igikoni',
    'checkout.cardNumber': 'Nimero y\'Ikarita (1234 5678 9012 3456)',
    'checkout.expiry': 'MM/YY',
    'checkout.cvv': 'CVV',
    'checkout.specialRequests': 'Ibyifuzo Byihariye',
    'checkout.specialRequestsPlaceholder': 'Ibisabwa byihariye cyangwa ibyifuzo?',
    'checkout.acceptTerms': 'Ndemera',
    'checkout.cancellationPolicy': 'politiki yo guhagarika',
    'checkout.bookingSummary': 'Incamake y\'Itangazo',
    'checkout.completeBooking': 'Soza Itangazo',
    'checkout.totalPrice': 'Igiciro Cyose',
    'checkout.connectWallet': 'Huza Umufuka',
    'checkout.mobileMoneyTitle': 'Kwishyura kwa Mobile Money',
    'checkout.mobileMoneyDesc': 'Uzakira ubutumwa kuri telefoni yawe kugirango urangize kwishyura',
  ...
  FR: {
    ...
    'auth.resendEmail': "Vous n'avez pas reçu l'email? Cliquez pour renvoyer",
    'auth.brandName': 'Merry360X',
    
    // Checkout & Payment
    'checkout.title': 'Finalisez Votre Réservation',
    'checkout.guestInfo': 'Informations sur l\'Invité',
    'checkout.firstName': 'Prénom',
    'checkout.lastName': 'Nom',
    'checkout.email': 'Email',
    'checkout.phone': 'Numéro de Téléphone (ex., +250 7XX XXX XXX)',
    'checkout.paymentMethod': 'Méthode de Paiement',
    ...
    'checkout.cvv': 'CVV',
    'checkout.specialRequests': 'Demandes Spéciales',
    'checkout.specialRequestsPlaceholder': 'Des exigences ou demandes spéciales?',
    'checkout.acceptTerms': 'J\'accepte la',
    'checkout.cancellationPolicy': 'politique d\'annulation',
    'checkout.bookingSummary': 'Résumé de la Réservation',
    'checkout.completeBooking': 'Finaliser la Réservation',
    'checkout.totalPrice': 'Prix Total',
    'checkout.connectWallet': 'Connecter le Portefeuille',
    'checkout.mobileMoneyTitle': 'Paiement Mobile Money',
    'checkout.mobileMoneyDesc': 'Vous recevrez une notification sur votre téléphone pour compléter le paiement',
  ...
  ZH: {
    ...
    'auth.resendEmail': '没收到邮件？点击重新发送',
    'auth.brandName': 'Merry360X',
    
    // Checkout & Payment
    'checkout.title': '完成您的预订',
    'checkout.guestInfo': '客人信息',
    ...
    'checkout.cvv': 'CVV',
    'checkout.specialRequests': '特殊要求',
    'checkout.specialRequestsPlaceholder': '有什么特殊要求或请求吗？',
    ...
    'checkout.mobileMoneyDesc': '您将在手机上收到提示以完成支付',
  ...
  SW: {
    ...
    'auth.resendEmail': 'Hukupata barua pepe? Bonyeza kutuma tena',
    'auth.brandName': 'Merry360X',
    
    // Checkout & Payment
    'checkout.title': 'Kamilisha Uhifadhi Wako',
    'checkout.guestInfo': 'Maelezo ya Mgeni',
    'checkout.firstName': 'Jina la Kwanza',
    'checkout.lastName': 'Jina la Mwisho',
    'checkout.email': 'Barua Pepe',
    'checkout.phone': 'Nambari ya Simu (mfano, +250 7XX XXX XXX)',
    'checkout.paymentMethod': 'Njia ya Malipo',
    'checkout.creditCard': 'Kadi ya Mkopo / Kadi ya Malipo',
    'checkout.mobileMoney': 'Pesa za Simu',
    'checkout.cardNumber': 'Nambari ya Kadi (1234 5678 9012 3456)',
    'checkout.expiry': 'MM/YY',
    'checkout.cvv': 'CVV',
    'checkout.specialRequests': 'Maombi Maalum',
    'checkout.specialRequestsPlaceholder': 'Mahitaji au maombi maalum yoyote?',
    'checkout.acceptTerms': 'Nakubali',
    'checkout.cancellationPolicy': 'sera ya kufuta',
    'checkout.bookingSummary': 'Muhtasari wa Uhifadhi',
    'checkout.completeBooking': 'Kamilisha Uhifadhi',
    'checkout.totalPrice': 'Bei Jumla',
    'checkout.connectWallet': 'Unganisha Mkoba',
    'checkout.mobileMoneyTitle': 'Malipo ya Pesa za Simu',
    'checkout.mobileMoneyDesc': 'Utapokea orodha kwenye simu yako kukamilisha malipo',
