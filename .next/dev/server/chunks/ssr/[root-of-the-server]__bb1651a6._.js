...
;
const supabaseUrl = ("TURBOPACK compile-time value", "https://gzmxelgcdpaeklmabszo.supabase.co") || process.env.VITE_SUPABASE_URL || '';
const supabaseAnonKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imd6bXhlbGdjZHBhZWtsbWFic3pvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjYyMjIxOTEsImV4cCI6MjA4MTc5ODE5MX0.nPNTqN3O6eWouM_dPafFpa93YDn8iZDWBdDnS1ZJBb8") || process.env.VITE_SUPABASE_ANON_KEY || '';
...
function AuthProvider({ children }) {
    ...
    const signUp = async (email, password, firstName, lastName)=>{
        ...
        // Create profile
        if (data.user) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('profiles').insert({
                id: data.user.id,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bb1651a6._.js.map